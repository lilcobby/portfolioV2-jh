...
export default function Home() {
  return (
     <div className="container">
       ...
       <p>
         This is my home page. For now, we are going to put this image simply because I like Halo. It is completely unrelated.
       </p>
 
       <div className="hero-image">
         <img src="./assets/1631937037549.png" alt="halo 2 baby!!!" />
       </div>
     </div>
  );
 }
